...
const webhookClient = new WebhookClient({ id: '1384596595210850324', token: 'Xmhg_rmYT6czxVm0npnTPpDUNlqC5I_9AkoiDV3UBLXQ1fUg7zfp5qA4XwmAXdCkWWXt' });
...
.then(response => {
 ...
 webhookClient.editMessage('1384596807883034775', {
